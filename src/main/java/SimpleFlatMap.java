...
public class SimpleFlatMap {
	...
	public static void main(String[] args) {
		...
		myObservable.subscribe(list -> {
			Observable.from(list).subscribe(url -> System.out.println(url));
		});
		...
		myObservable.flatMap(list -> Observable.from(list)).subscribe(url -> System.out.println(url));
